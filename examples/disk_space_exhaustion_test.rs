...
fn fill_disk_space(path: &Path, leave_bytes: u64) -> Result<Vec<String>, Box<dyn std::error::Error>> {
    ...
    println!("  Filling {} MB of disk space (leaving {} KB free)", 
             to_fill / 1_048_576, leave_bytes / 1024);
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("===============================================");
    {
        ...
        println!("  ✓ Writes: {} successful, {} failed", successful_writes, failed_writes);
        ...
        println!("  ✓ Initial data integrity: {}/100 entries verified", verified);
    ...
    println!("============================");
    {
        ...
        println!("  Initial available space: {} MB", initial_space / 1_048_576);
        ...
        for iteration in 0..10 {
            ...
            let available = get_available_space(db_path)?;
            println!("\n  Iteration {}: {} MB free", iteration, available / 1_048_576);
