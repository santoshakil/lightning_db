...
fn worker_main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Worker {} starting: {} operations of type {}",
    ...
    match config.operation_type.as_str() {
        ...
        "read" => {
            ...
            println!(
                "Worker {} read hits: {}/{}",
                config.worker_id, hits, config.operation_count
            );
        }
        "mixed" => {
            use rand::Rng;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("=====================================");
    {
        ...
        let duration = start.elapsed();
        println!(
            "  ✓ Mixed operations completed in {:.2}s",
            duration.as_secs_f64()
        );
    }
    ...
    println!("======================================");
    {
        ...
        let duration = start.elapsed();
        println!(
            "  ✓ Transaction test completed in {:.2}s",
            duration.as_secs_f64()
        );
    }
    ...
    println!("================================");
    {
        ...
        let duration = start.elapsed();
        println!(
            "  ✓ High contention test completed in {:.2}s",
            duration.as_secs_f64()
        );
    }
    ...
    println!("================================");
    {
        ...
        println!(
            "  ✓ Integrity check: {} pages, {} keys, {} errors",
    ...
    if let Ok(exe_name) = std::env::current_exe() {
        if exe_name
            .to_string_lossy()
            .contains("multi_process_concurrent_test")
        {
            println!(
