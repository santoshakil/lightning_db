...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("==================================");
    {
        ...
        println!(
            "  ✓ Breakdown: {} reads, {} writes, {} updates",
                ...
                for tx_num in 0..transactions_per_thread {
                    match db_clone.begin_transaction() {
                        Ok(tx_id) => {
                            ...
                            for i in 0..10 {
                                let key =
                                    format!("tx_thread_{}_tx_{}_key_{}", thread_id, tx_num, i);
    ...
    println!("===========================");
    {
        ...
        println!(
            "  ✓ Recovered {}/100 entries after simulated crash",
            recovered
        );
        ...
        if report.errors.is_empty() {
            ...
            println!(
                "  ⚠️  {} integrity errors after crash recovery",
                report.errors.len()
            );
        }
    }
    ...
    println!("============================");
    {
        ...
        println!(
            "  ✓ Wrote {}MB in {:.2}s",
            (num_values * value_size) / 1_000_000,
            write_duration.as_secs_f64()
        );
        println!(
            "  ✓ Random reads: {}/1000 successful in {:.2}s",
            hits,
