...
fn test_queue_stress() {
    ...
    for _ in 0..num_consumers {
        ...
        let handle = thread::spawn(move || {
            while consumed_clone.load(Ordering::Relaxed) < (num_producers * items_per_producer) as u64 {
...
fn test_database_stress() {
    ...
    println!("  Throughput: {:.2} ops/sec", total_operations as f64 / elapsed.as_secs_f64());
