...
fn test_extreme_key_sizes(db: Arc<Database>) {
    ...
    for (i, key) in special_keys.iter().enumerate() {
        db.put(key, format!("special_{}", i).as_bytes())
            .expect("Put failed");
    }
    ...
    for thread_id in 0..num_threads {
        ...
        let handle = thread::spawn(move || {
            ...
            for i in 0..100 {
                ...
                db_clone
                    .put_tx(tx, conflict_key, new_value.as_bytes())
                    .expect("Put failed");
...
fn test_memory_exhaustion(db: Arc<Database>) {
    ...
    db.put(b"recovery_test", b"success")
        .expect("Recovery put failed");
            ...
            for tx_num in 0..transactions_per_thread {
                ...
                for _ in 0..10 {
                    ...
                    if rng.random_bool(0.5) {
                        ...
                        db_clone
                            .put_tx(tx, key.as_bytes(), value.as_bytes())
                            .expect("Put failed");
                    }
                }
