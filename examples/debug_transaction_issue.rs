...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match db.begin_transaction() {
        Ok(tx_id) => {
            ...
            match db.get_tx(tx_id, b"test_key") {
                Ok(Some(value)) => println!("   ✅ Transaction get successful: {:?}", String::from_utf8_lossy(&value)),
    ...
    println!("   ✅ Created multiple transactions: {}, {}, {}", tx1, tx2, tx3);
...
fn test_single_transfer(db: &Database, from: usize, to: usize, amount: i32) -> Result<(), Box<dyn std::error::Error>> {
    let tx_id = db.begin_transaction()?;
    ...
    println!("     From balance: {}, To balance: {}, Transfer amount: {}", 
