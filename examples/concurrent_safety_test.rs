...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("==================================");
    {
        ...
        println!("  ✓ {} concurrent operations on same key completed in {:.2}s", 
                 num_threads * ops_per_thread, duration.as_secs_f64());
    ...
    println!("========================================");
    {
                ...
                for _ in 0..100 {
                    ...
                    match db_clone.begin_transaction() {
                        Ok(tx_id) => {
                            ...
                            // Write back
                            if db_clone.put_tx(tx_id, b"counter", new_value.as_bytes()).is_ok() {
                                // Try to commit
        ...
        if final_value <= successes as i32 {
            ...
            panic!("Counter value {} exceeds successful commits {}!", final_value, successes);
        }
    }
    ...
    println!("==================================");
    {
        ...
        let duration = start.elapsed();
        println!("  ✓ Concurrent bulk operations completed in {:.2}s", duration.as_secs_f64());
    }
    ...
    println!("====================================");
    {
                        ...
                        *local_counts.entry("deletes").or_insert(0) += 1;
                        ...
                        if let Ok(tx_id) = db_clone.begin_transaction() {
                            for i in 0..5 {
                                ...
                                let _ = db_clone.put_tx(tx_id, tx_key.as_bytes(), tx_value.as_bytes());
                            }
        ...
        println!("  ✓ {} random operations completed in {:.2}s", total_ops, duration.as_secs_f64());
    ...
    println!("=============================");
    {
        ...
        println!("  ✓ Sampled 100 random keys: {} found, {} missing", found, missing);
    }
