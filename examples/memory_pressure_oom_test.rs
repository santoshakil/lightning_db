...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("==================================");
    {
        ...
        println!(
            "  ✓ Concurrent test completed in {:.2}s",
    ...
    println!("====================================");
    {
        ...
        println!(
            "  ✓ {} writes successful after memory release",
            recovery_writes
        );
    ...
    println!("============================");
    {
        ...
        println!(
            "  ✓ Random access: {} hits in {:.2}s",
            hits,
            random_time.as_secs_f64()
        );
    ...
    println!("====================");
    {
        ...
        if delta < 50 * 1024 {
            ...
            println!(
                "  ✓ Memory usage returned close to baseline (Δ {} MB)",
                delta / 1024
            );
        } else {
            println!(
                "  ⚠️  Potential memory leak detected (Δ {} MB)",
                delta / 1024
            );
        }
    }
