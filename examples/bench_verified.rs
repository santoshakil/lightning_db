...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Phase 1: Testing write performance...");
    {
        ...
        println!("  • Status: {}", if write_ops_per_sec >= 100_000.0 { "✅ PASS" } else { "❌ FAIL" });
    ...
    println!("\nPhase 2: Verifying data persistence...");
    {
        ...
        if verified == test_indices.len() {
            println!("  • Sample keys verified: ✅ PASS ({}/{})", verified, test_indices.len());
        } else {
            println!("  • Sample keys verified: ❌ FAIL ({}/{})", verified, test_indices.len());
        }
        ...
        if count == write_count {
            ...
            println!("  • Key count mismatch: ❌ FAIL ({}/{})", count, write_count);
        }
    }
    ...
    println!("\nPhase 3: Testing batched writes with verification...");
    {
        ...
        println!("  • Status: {}", if batch_ops_per_sec >= 100_000.0 { "✅ PASS" } else { "❌ FAIL" });
