...
fn main() {
    ...
    println!("   Memory: {:.2} MB", initial_memory as f64 / 1024.0 / 1024.0);
    ...
    *should_stop.lock().unwrap() = true;
    ...
    println!("   Error Rate: {:.4}%", total_errors as f64 / total_ops.max(1) as f64 * 100.0);
    ...
    println!("   Growth: {:.2} MB", (final_memory as i64 - initial_memory as i64) as f64 / 1024.0 / 1024.0);
    
    println!("\n📁 File Descriptors:");
    println!("   Initial: {}", initial_fd_count);
    println!("   Final: {}", final_fd_count);
    println!("   Change: {}", final_fd_count as i32 - initial_fd_count as i32);
    ...
    if memory_growth > 10 * 1024 * 1024 { // 10MB growth
        issues.push(format!("High memory growth: {:.2} MB", memory_growth as f64 / 1024.0 / 1024.0));
    }
