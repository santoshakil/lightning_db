...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("===============================================");
    {
        ...
        for i in 0..1000 {
            ...
            if !success {
                println!("  ⚠️  Failed to write key {} after {} retries", key, max_retries);
            }
        }
        
        println!("  ✓ Writes: {} successful, {} failed, {} required retries", 
        ...
        println!("  ✓ Data verification: {}/{} keys persisted", verified, successful_writes);
    }
    ...
    println!("==============================================");
    {
                    ...
                    match db_clone.begin_transaction() {
                        Ok(tx_id) => {
                            ...
                            for i in 0..5 {
                                ...
                                if network_clone.simulate_operation(|| {
        ...
        println!("  ✓ Transactions: {} completed, {} aborted", completed, aborted);
        println!("  ✓ Success rate: {:.1}%", (completed as f64 / (completed + aborted) as f64) * 100.0);
    }
    ...
    println!("==============================================");
    {
        ...
        println!("  ✓ Network outage lasted {:.2}s", outage_duration.as_secs_f64());
        ...
        println!("  ✓ Post-recovery writes: {}/50 successful", post_recovery_writes);
        ...
        if report.errors.is_empty() {
            ...
            println!("  ⚠️  {} integrity errors after recovery", report.errors.len());
        }
    }
    ...
    println!("===================================================");
    {
        ...
        println!("  ✓ Completed in {:.2}s", duration.as_secs_f64());
        println!("  ✓ Operations: {}/{} successful ({:.1}%)", 
        ...
        println!("  ✓ Final state: {} total keys, {} errors", 
                 report.statistics.total_keys, report.errors.len());
    }
