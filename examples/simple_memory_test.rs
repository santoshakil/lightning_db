...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("================================");
    {
        ...
        println!("  ✓ Random reads: {}/1000 in {:.2}s", hits, read_duration.as_secs_f64());
    }
    ...
    println!("=============================");
    {
        ...
        println!("  ✓ Concurrent operations completed in {:.2}s", duration.as_secs_f64());
    }
    ...
    println!("===========================");
    {
        ...
        println!("  Sequential read: {:.2}ms", seq_time.as_secs_f64() * 1000.0);
        println!("  Random read: {:.2}ms", random_time.as_secs_f64() * 1000.0);
        println!("  Cache speedup: {:.2}x", random_time.as_secs_f64() / seq_time.as_secs_f64());
    }
