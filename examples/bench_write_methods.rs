use lightning_db::{Database, LightningDbConfig, WalSyncMode, simple_batcher::SimpleBatcher};
use std::sync::Arc;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Verification
    {
        ...
        println!("✅ Verified {} keys - manual batching data persisted correctly!", verified);
    }
