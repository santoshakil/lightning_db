# AWS Infrastructure for Lightning DB
...
output "database_endpoint" {
  ...
  value       = "http://${aws_eks_cluster.main.endpoint}:8080"
}

output "monitoring_endpoint" {
  description = "Monitoring dashboard endpoint"
  value       = var.enable_monitoring ? "http://${aws_eks_cluster.main.endpoint}:3000" : null
}

output "backup_bucket" {
  description = "S3 backup bucket name"
  value       = var.enable_backup ? aws_s3_bucket.backups[0].bucket : null
}