...
pub use adaptive_compression::{AdaptiveCompressionConfig, AdaptiveCompressionEngine, DataPattern};
...
mod tests {
    ...
    fn test_adaptive_compression_repetitive_data() {
        ...
        assert!(matches!(
            best,
            CompressionType::Zstd | CompressionType::Snappy | CompressionType::Lz4
        ));
