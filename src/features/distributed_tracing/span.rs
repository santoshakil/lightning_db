...
use super::{LogLevel, Span, SpanKind, SpanStatus, TraceContext};
...
impl DatabaseSpanBuilder {
    ...
    pub fn with_operation(mut self, operation: &str) -> Self {
        self.span
            .set_tag("db.operation".to_string(), operation.to_string());
        self
    }
    ...
    pub fn with_key_pattern(mut self, pattern: &str) -> Self {
        self.span
            .set_tag("db.key_pattern".to_string(), pattern.to_string());
        self
    }
    ...
    pub fn with_transaction_id(mut self, tx_id: u64) -> Self {
        self.span
            .set_tag("db.transaction_id".to_string(), tx_id.to_string());
        self
    }
    ...
    pub fn with_record_count(mut self, count: usize) -> Self {
        self.span
            .set_tag("db.record_count".to_string(), count.to_string());
        self
    }
    ...
    pub fn with_data_size(mut self, size_bytes: usize) -> Self {
        self.span
            .set_tag("db.data_size_bytes".to_string(), size_bytes.to_string());
        self
    }
...
impl DatabaseSpan {
    ...
    pub fn record_cache_hit(&mut self) {
        ...
        self.span
            .set_tag("db.cache_hit".to_string(), "true".to_string());
    }
    ...
    pub fn record_cache_miss(&mut self) {
        ...
        self.span
            .set_tag("db.cache_hit".to_string(), "false".to_string());
    }
    ...
    pub fn record_memory_allocation(&mut self, bytes: usize) {
        ...
        self.span
            .set_tag("db.memory_allocated".to_string(), bytes.to_string());
    }
    ...
    pub fn record_error(&mut self, error: &str, error_code: Option<&str>) {
        ...
        if let Some(code) = error_code {
            self.span
                .set_tag("error.code".to_string(), code.to_string());
        }
    ...
    pub fn finish(mut self) -> CompletedDatabaseSpan {
        ...
        self.span.set_tag(
            "db.cache_hits".to_string(),
            self.metrics.cache_hits.to_string(),
        );
        self.span.set_tag(
            "db.cache_misses".to_string(),
            self.metrics.cache_misses.to_string(),
        );
        self.span.set_tag(
            "db.io_operations".to_string(),
            self.metrics.io_operations.to_string(),
        );
        self.span.set_tag(
            "db.bytes_processed".to_string(),
            self.metrics.bytes_processed.to_string(),
        );
        self.span.set_tag(
            "db.memory_allocated".to_string(),
            self.metrics.memory_allocated.to_string(),
        );
        self.span
            .set_tag("db.errors".to_string(), self.metrics.errors.to_string());
        self.span.set_tag(
            "db.successes".to_string(),
        ...
        if self.metrics.cache_hits + self.metrics.cache_misses > 0 {
            ...
            self.span
                .set_tag("db.cache_hit_rate".to_string(), format!("{:.3}", hit_rate));
        }
        ...
        if duration.as_secs_f64() > 0.0 {
            ...
            self.span.set_tag(
                "db.throughput_bytes_per_sec".to_string(),
                format!("{:.0}", throughput),
            );
        }
...
mod tests {
    ...
    fn test_database_span_builder() {
        ...
        assert_eq!(
            span.span.tags.get("db.operation"),
