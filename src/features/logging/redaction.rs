    ...
    pub fn new() -> Self {
        let patterns = vec![
            (
                ...
                Regex::new(&RedactionPatterns::credit_card()).unwrap(),
            ),
            (
                "email".to_string(),
                Regex::new(&RedactionPatterns::email()).unwrap(),
            ),
            (
                "phone".to_string(),
                Regex::new(&RedactionPatterns::phone()).unwrap(),
            ),
            (
                "ssn".to_string(),
                Regex::new(&RedactionPatterns::ssn()).unwrap(),
            ),
            (
                "jwt".to_string(),
                Regex::new(&RedactionPatterns::jwt()).unwrap(),
            ),
        ];
...
mod tests {
    ...
    fn test_basic_redaction() {
        let redactor = Redactor::new(vec!["secret".to_string()], "[REDACTED]".to_string());
    ...
    fn test_credit_card_redaction() {
        let redactor = Redactor::new(vec![RedactionPatterns::credit_card()], "[CARD]".to_string());
    ...
    fn test_json_redaction() {
        let redactor =
            Redactor::new(vec![], "[REDACTED]".to_string()).with_redaction_settings(false, true);
