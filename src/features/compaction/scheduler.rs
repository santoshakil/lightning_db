...
impl MaintenanceScheduler {
    ...
    async fn schedule_initial_tasks(&self) -> Result<()> {
        ...
        self.schedule_task(CompactionType::Minor, TaskPriority::Medium, Some(interval))
            .await?;
    ...
    async fn update_stats_on_completion(&self, duration: Duration) {
        ...
        let total_duration = stats.avg_task_duration.as_secs_f64()
            * (stats.tasks_completed - 1) as f64
            + duration.as_secs_f64();
        stats.avg_task_duration =
            Duration::from_secs_f64(total_duration / stats.tasks_completed as f64);
    }
