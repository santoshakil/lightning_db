...
#[derive(
    Debug, Clone, Serialize, Deserialize, Eq, PartialEq, Hash, bincode::Encode, bincode::Decode,
)]
    ...
    pub fn get_previous_version(&self, current: &SchemaVersion) -> Result<SchemaVersion> {
        ...
        if current.patch > 0 {
            ...
            Err(Error::InvalidOperation {
                reason: "Cannot get previous version of 0.0.0".to_string(),
            })
        }
    }
