use crate::performance::cache::{AdaptivePolicy, CachePolicy, CachedPage, LruPolicy, MemoryConfig};
...
impl MemoryPool {
    pub fn new(page_manager: Arc<RwLock<PageManager>>, config: MemoryConfig) -> Self {
        let cache_capacity = config.hot_cache_size / crate::core::storage::PAGE_SIZE;
    ...
    pub fn get_cache_stats(&self) -> MemoryPoolStats {
        ...
        MemoryPoolStats {
            ...
            hot_cache_size: (stats.recent_entries * crate::core::storage::PAGE_SIZE) as u64,
            cold_cache_size: (stats.frequent_entries * crate::core::storage::PAGE_SIZE) as u64,
