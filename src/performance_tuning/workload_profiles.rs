...
impl WorkloadProfileGenerator {
    ...
    pub fn generate_oltp_profile(&self) -> WorkloadConfigProfile {
        ...
        WorkloadConfigProfile {
            name: "OLTP".to_string(),
            description: "Optimized for high-concurrency, low-latency transactional workloads".to_string(),
    ...
    pub fn generate_mixed_profile(&self) -> WorkloadConfigProfile {
        ...
        WorkloadConfigProfile {
            ...
            description: "Balanced profile for mixed transactional and analytical workloads".to_string(),
...
mod tests {
    use super::*;
    use crate::performance_tuning::workload_profiler::{AccessPatterns, KeyDistribution, OperationMix, BatchCharacteristics};
    ...
    fn test_custom_profile_generation() {
        ...
        let custom = generator.generate_custom_profile(
            "ReadHeavy".to_string(),
            &read_heavy_profile,
        );
    ...
    fn test_config_application() {
        ...
        let optimized_config = WorkloadProfileGenerator::apply_profile_to_config(
            &oltp_profile,
            base_config,
        );
