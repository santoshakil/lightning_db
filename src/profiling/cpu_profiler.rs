...
impl CpuProfiler {
    ...
    pub fn start(&self) -> Result<(), super::ProfilingError> {
        ...
        let handle = thread::Builder::new()
            ...
            .map_err(|e| super::ProfilingError::CpuProfilerError(
        ...
        for (function_key, count) in function_counts {
            ...
            if parts.len() >= 2 {
                ...
                top_functions.push(CpuHotspot {
                    ...
                    cpu_percentage,
                    sample_count: count,
                    exclusive_time: Duration::from_nanos((cpu_percentage / 100.0 * 1_000_000.0) as u64),
                    inclusive_time: Duration::from_nanos((cpu_percentage / 100.0 * 1_000_000.0) as u64),
