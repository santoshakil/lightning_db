...
pub struct StreamingCompressor {
    ...
    /// Processed chunks
    processed_chunks: Arc<RwLock<VecDeque<CompressionChunk>>>,
    /// Current algorithm
    current_algorithm: Arc<RwLock<CompressionAlgorithm>>,
    /// Current level
    current_level: Arc<RwLock<CompressionLevel>>,
    /// Statistics
...
impl StreamingCompressor {
    ...
    pub fn new(config: StreamingConfig, engine: Arc<AdaptiveCompressionEngine>) -> Result<Self> {
        ...
        Ok(Self {
            ...
            processed_chunks: Arc::new(RwLock::new(VecDeque::new())),
            current_algorithm: Arc::new(RwLock::new(CompressionAlgorithm::LZ4)),
            current_level: Arc::new(RwLock::new(CompressionLevel::Balanced)),
