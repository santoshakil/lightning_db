...
use crate::core::storage::{Page, PageManager, PageManagerAsync, PageType, PAGE_SIZE};
...
impl PageScanner {
    ...
    /// Validate free page
    fn validate_free_page(&self, _page: &Page, _page_id: u64) -> bool {
    ...
    fn calculate_used_space(&self, _page: &Page, key_count: usize) -> usize {
