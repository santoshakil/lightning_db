...
use super::{ComparisonOperator, DataType, SIMDSupport};
...
impl SIMDOperations for ScalarOperations {
    fn compare_vectors(
        ...
        match data_type {
            ...
            _ => Err(Error::Generic(
                "Data type not supported for comparison".to_string(),
            )),
        }
    }
    ...
    fn compare_scalar(
        ...
        match data_type {
            ...
            _ => Err(Error::Generic(
                "Data type not supported for scalar comparison".to_string(),
            )),
        }
    }
    ...
    fn sum_vector(&self, values: &[u8], data_type: DataType) -> Result<f64> {
        match data_type {
            ...
            _ => Err(Error::Generic(
                "Data type not supported for sum".to_string(),
            )),
        }
    }
    ...
    fn min_vector(&self, values: &[u8], data_type: DataType) -> Result<f64> {
        match data_type {
            ...
            _ => Err(Error::Generic(
                "Data type not supported for min".to_string(),
            )),
        }
    }
    ...
    fn max_vector(&self, values: &[u8], data_type: DataType) -> Result<f64> {
        match data_type {
            ...
            _ => Err(Error::Generic(
                "Data type not supported for max".to_string(),
            )),
        }
    }
