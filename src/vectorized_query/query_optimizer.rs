...
use super::{
    AggregateFunction, ComparisonOperator, DataType, ExecutionPlan, FilterExpression,
    JoinCondition, JoinType, QueryOperation, SIMDSupport, SortColumn, TableStatistics, Value,
};
use crate::Result;
...
impl VectorizedOptimizer {
    ...
    pub fn optimize(
        ...
        hints: Option<OptimizationHints>,
    ...
    fn can_vectorize_filter(
        ...
        match expression {
            ...
            FilterExpression::Not(expr) => self.can_vectorize_filter(expr, table_stats),
    ...
    pub fn estimate_cost(
        ...
        match operation {
            ...
            QueryOperation::Sort { columns } => self.estimate_sort_cost(columns, table_stats),

            QueryOperation::Project { columns } => self.estimate_project_cost(columns, table_stats),
    ...
    fn estimate_aggregate_cost(
        ...
        let base_cost =
            group_count * self.cost_model.aggregate_cost_per_group * functions.len() as f64;
    ...
    fn estimate_join_cost(
        &self,
        _left: &QueryOperation,
        _right: &QueryOperation,
        _join_type: JoinType,
