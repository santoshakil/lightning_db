...
use super::{DataType, FilterExpression, SIMDOperations, Value};
    ...
    fn evaluate_expression(
        ...
        match expression {
            FilterExpression::Column {
                ...
                self.simd_ops
                    .compare_scalar(data, &scalar_bytes, data_type, *operator)
            }
            ...
            _ => Err(Error::Generic(
                "Filter expression not implemented".to_string(),
            )),
        }
    }
