...
pub struct FlushResult {
    pub sstable_metadata: Vec<crate::core::write_optimized::SSTableMetadata>,
...
#[derive(Debug)]
struct FlushRequest {
    memtable: Arc<crate::core::write_optimized::MemTable>,
...
impl WriteOptimizedEngine {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        let _tiered_storage = Arc::clone(&self.tiered_storage);
    ...
    fn flush_memtable(
        ...
        for (key, entry) in memtable.iter() {
            match entry.entry_type {
                ...
                crate::core::write_optimized::memtable::EntryType::Delete => {
                    // For deletes, we still need to write a tombstone
                    builder.add(key.clone().to_vec(), Vec::new())?;
    ...
    pub fn memtable_stats(&self) -> crate::core::write_optimized::memtable::MemTableManagerStats {
        self.memtable_manager.stats()
    }

    /// Get compaction statistics
    pub fn compaction_stats(&self) -> crate::core::write_optimized::compaction::CompactionStats {
    ...
    pub fn tier_stats(
        &self,
    ) -> HashMap<StorageTier, crate::core::write_optimized::tiered_storage::TierStats> {
...
mod tests {
    ...
    fn test_write_engine_creation() {
        ...
        let _engine = WriteOptimizedEngine::new(config).unwrap();
